function [c,ceq] = constraintFcnValidation_pendel(optimized_translational_values_5_6,init_optimization_values,optimized_translational_values, orientationsPendulum, passes, acceptableOrientationDifference)
...
%% =========Feste Variablen==========================================
    % velocity GRAD/SEC
    max_velocity = deg2rad([80,80,100]);
    min_velocity = deg2rad([-80,-80,-100]);
