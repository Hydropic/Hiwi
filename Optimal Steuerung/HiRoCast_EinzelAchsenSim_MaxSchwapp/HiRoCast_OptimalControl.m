...
% load("Zwischenstand_Vor_ZOpti.mat")
axesPointConfigs = transpose(deg2rad( ...
               [178.299533, -51.598823, 110.269106, -108.774502, 78.915396, 60.508372;...   %Pos 1
                82.233872, -38.468876, 77.942636, -219.630360, 46.918753, 119.495339]));     %Pos 4

% save("Zwischenstand_Vor_ZOpti.mat")
a = 0.05; 
timeSteps = [0.90449308069551+a];       %3

VelocityBoundaryCondition_x =       [0.0];
AccelerationBoundaryCondition_x =   [0.0];


VelocityBoundaryCondition_y =       [0.0];
AccelerationBoundaryCondition_y =   [0.0];
...
max_values = [timeMax timeMax timeMax;... 
...
if booleanFormTCP
    if bool_skp_Optimirung_Kat == 0
        ...
        VelocityBoundaryCondition_z =       [0.0];
        AccelerationBoundaryCondition_z =   [0.0];
        ...
        min_values_Z = [x_xy(1,:) 0.0 0.0; 
                  -5.0 -5.0 0.0; 
                  -5.0 -5.0 0.0];
    
        max_values_Z = [x_xy(1,:) 0.0 0.0; 
                      5.0 5.0 0.0;  
                      5.0 5.0 0.0];
