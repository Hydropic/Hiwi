...
if breite == 7
   for t = 1:length(optimization_values(1,:))
    ...
    if visualizeTCPPath
        ...
        yline(max_values(2,2), 'r')
        yline(min_values(2,2), 'r')
        yline(max_values(2,2), 'y')
        yline(min_values(2,2), 'y')
        legend('X','Y','Z') 
        ...
        yline(max_values(3,2), 'r')
        yline(min_values(3,2), 'r')
        yline(max_values(3,2), 'y')
        yline(min_values(3,2), 'y')
        legend('X','Y','Z') 
...
elseif breite == 3
    ...
    if visualizeTCPPath
        ...
        yline(max_values(2,1), 'y')
        yline(min_values(2,1), 'y')
        legend('Z') 
        ...
        yline(max_values(3,1), 'y')
        yline(min_values(3,1), 'y')
        legend('Z') 
