...
axesPointConfigs = transpose(deg2rad( ...
               [145.192782, -55.944346, 120.263941, -122.068637, 75.678415, 68.455297;...   %Pos 1
...
% %load("Zwischenstand_Vor_ZOpti.mat")
% axesPointConfigs = transpose(deg2rad( ...
%                [135.797813, -59.614591, 131.648082, -156.538976, 73.434035, 82.945922;...   %Pos 1
%                 85.742532, -56.970270, 123.237170, -204.475865, 68.191232, 99.598915;...   %Pos 2
%                 77.066174, -46.974164, 97.007535, -181.694465, 50.045707, 91.088331;...   %Pos 3
%                 71.046216, -38.614348, 77.168457, -183.717259, 38.612937, 92.906178]));     %Pos 4
% %save("Zwischenstand_Vor_ZOpti.mat")

a = 0.05; 
timeSteps = [0.50449308069551+a ...	    %1
             0.48449308069551+a ...	    %2
             0.80449308069551+a];       %3

VelocityBoundaryCondition_x =       [1.11626424791510	1.11626424791510	0.0];
AccelerationBoundaryCondition_x =   [-3.31940823068824  -3.31940823068824	0.0];


VelocityBoundaryCondition_y =       [-1.18494663299643  -1.18494663299643	0.0];
AccelerationBoundaryCondition_y =   [4.48604587496325	4.48604587496325	0.0];
...
max_values = [timeMax 0.7 0.7;... 
              vel vel 0.0;... 
              vel vel 0.0;...  
              acc acc 0.0;... 
              acc acc 0.0];

min_values = [timeMin timeMin 0.5;... 
              -vel -vel 0.0;...
              -vel -vel 0.0;... 
              -acc -acc 0.0;...
              -acc -acc 0.0];
...
if booleanFormTCP
    if bool_skp_Optimirung_Kat == 0
        ...
        %load("Zwischenstand_Vor_ZOpti.mat")
        [x_z, optiResuls] = splineOptimization_z(optimalSplineDiscretization, 1, splineDiscretization, axesPointConfigs, min_values_Z, max_values_Z, jerkBoundaries, init_ax_values_Z);
