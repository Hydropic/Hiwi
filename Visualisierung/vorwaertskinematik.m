...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%[Körper 7: Kelle]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    R7 = RotationUmZ(deg2rad(0))*RotationUmY(deg2rad(0))*RotationUmX(deg2rad(-90));%Intrinsisch
    R7_ =RotationUmZ(deg2rad(-90))*RotationUmY(deg2rad(0))*RotationUmX(deg2rad(-90));%Extrinsisch
    V7 = [0 0 0.500];
    tform7 = [R7    V7';
              0 0 0 1];
    tform7_ = [R7_    V7';%test
