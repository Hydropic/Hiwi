...
% Solve
[solution,objectiveValue] = ga(objfun4,nvars,[],[],[],[],lb,ub,@(optimization_values)constraintFcnValidation(optimization_values,init_ax_values,regression,simulation_data),...
    [],options4);
