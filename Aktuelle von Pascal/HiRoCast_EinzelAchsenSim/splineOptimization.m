function [x, optiResuls] = splineOptimization(maxIterations, splineDiscretization, startConfig, middleOneConfig, goalConfig, min_values, max_values, jerkBoundaries)
    ...
    problem = createOptimProblem('fmincon',...
        ...
        'nonlcon', @(optimization_values)constraintFcnValidation_spline(optimization_values, splineDiscretization, startConfig, middleOneConfig, goalConfig, max_values, min_values, jerkBoundaries), ...
        'lb',min_values,...
        'ub',max_values, ...
        'options',opts);
