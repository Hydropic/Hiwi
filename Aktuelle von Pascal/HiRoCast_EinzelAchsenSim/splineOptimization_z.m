function [x, optiResuls] = splineOptimization(maxIterationsSplineTCP, splineDiscretization, axesPointConfigs, min_values, max_values, jerkBoundaries, init_ax_values)
    ...
    problem = createOptimProblem('fmincon',...
        ...
        'nonlcon', @(optimization_values)constraintFcnValidation_spline_z(optimization_values, splineDiscretization, axesPointConfigs, max_values, min_values, jerkBoundaries), ...
        'lb',min_values,...
        'ub',max_values, ...
        'options',opts);
