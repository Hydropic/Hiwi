...
AccelerationBoundaryCondition_x =   [1.32791857795363	-1.31940823068824	0.0];


VelocityBoundaryCondition_y =       [-1.95367961344194	-1.18494663299643	0.0];
AccelerationBoundaryCondition_y =   [-1.90067458258856	1.48604587496325	0.0];
...
a = 0.00; 
timeSteps = [0.84449308069551+a ...	    %1
             0.80449308069551+a ...	    %2	
             0.80449308069551+a];        %3

max_values = [timeMax timeMax timeMax;...  
              vel vel 0.07;... 
              vel vel 0.8;...
              acc_x_TCP acc_x_TCP 0.4;...
              acc_y_TCP acc_y_TCP 0.49];
...
%         [Position_xyz, timeLine] = saveTCPPositionAsEMI(visualizeTCPPath, saveEMI, init_ax_values_YX, splineDiscretization, axesPointConfigs, min_values, max_values, jerkBoundaries);
        ...
        VelocityBoundaryCondition_z =       [-1.95367961344194	-1.18494663299643	0.0];
        AccelerationBoundaryCondition_z =   [-1.95367961344194	-1.18494663299643	0.0];
