...
axesPointConfigs = transpose(deg2rad( ...
               [142.513780, -41.097123, 80.986343, -101.421903, 76.670469, 41.228242;...   %Axe 1
                ...
                95.600904, -45.066846, 90.203635, -115.887495, 66.513816, 50.607434]));     %Axe 5
save("Zwischenstand_Vor_ZOpti.mat")



VelocityBoundaryCondition_x =       [1.89324092806605	1.11626424791510	1.11626424791510	0.0];
AccelerationBoundaryCondition_x =   [1.32791857795363	-1.31940823068824	-1.31940823068824	0.0];


VelocityBoundaryCondition_y =       [-1.95367961344194	-1.18494663299643	-1.18494663299643	0.0];
AccelerationBoundaryCondition_y =   [-1.90067458258856	1.48604587496325	1.48604587496325	0.0];
...
max_values = [timeMax timeMax timeMax timeMax;...  
              vel vel vel 0.07;... 
              vel vel vel 0.8;...
              acc_x_TCP acc_x_TCP acc_x_TCP  0.4;...
              acc_y_TCP acc_y_TCP acc_y_TCP 0.49];

min_values = [timeMin timeMin timeMin timeMin;... 
              -vel -vel -vel 0.07;... 
              -vel -vel -vel 0.8;... 
              -acc_x_TCP -acc_x_TCP -acc_x_TCP 0.4;...
              -acc_y_TCP -acc_y_TCP -acc_y_TCP 0.49];
...
% % %         [x_xy, optiResuls] = splineOptimization(optimalSplineDiscretization, maxIterationsSplineTCP, splineDiscretization, axesPointConfigs, min_values, max_values, jerkBoundaries, init_ax_values_YX);
        ...
        VelocityBoundaryCondition_z =       [1.89324092806605	1.11626424791510	1.11626424791510	0.0];
        AccelerationBoundaryCondition_z =   [1.89324092806605	1.11626424791510	1.11626424791510	0.0];
